...
```
I ran [simple plots in R](./TroubleShooting/) to explore the effect on Heterozygosity and inbreeding. Although the conclusions of the research remains unchanged, **I will utilise this final .vcf file for our analyses, making a more robust investigation.**
