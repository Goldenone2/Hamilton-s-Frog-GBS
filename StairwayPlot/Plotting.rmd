...
# Plotting
Geom_ribbon is creating the 95% confidence interval;Geom_Step is creating the Ne median line. I've borrowed the log scales limits from Stairway Plots native plots. 
```{r}
Stairway <- ggplot(Together, aes(x = yearK)) +
  ...
  scale_x_log10(limits = c(0.001, 20), labels = comma) +
