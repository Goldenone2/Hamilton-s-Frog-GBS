...
That was so hard to understand, and is confusing as hell, chatgpt is my friend here when it is *not* involved in real analysis. I'd recommend saving this as a .txt file for future and at least attempting to understand what is going on. 
```{r}
